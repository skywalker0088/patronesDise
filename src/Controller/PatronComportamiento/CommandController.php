...
use App\Services\PatronComportamiento\Command\ProblemTree\BurgerCommand;
use App\Services\PatronComportamiento\Command\ProblemTree\Chef;
use App\Services\PatronComportamiento\Command\ProblemTree\PizzaCommand;
use App\Services\PatronComportamiento\Command\ProblemTree\Waiter;
...
final class CommandController extends AbstractController
{
    ...
    public function index(): Response
    {
        ...
        $waiter->takeOrder(new BurgerCommand($chef));
        $waiter->takeOrder(new PizzaCommand($chef));

        $return[] = $waiter->sendOrders();
